    ...
    <div class="left-col">
        <div class="coupon-submit">
            <form class="coupon-submit-form">
                ...
                <input name="expiration" class="time-select optional hasDatepicker" readonly="" placeholder="Expire (optional)" id="dp1521256425878">
